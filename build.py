...
people+=lab_context
people+='<section class="pi"><h2>Group lead</h2><article class="person"><img src="assets/images/group/prof-saswata-bhattacharya.jpg" alt="Prof. Saswata Bhattacharyya" width="64" height="72"><div><h3>Prof. Saswata Bhattacharyya</h3><p>Professor, Materials Science and Metallurgical Engineering, IIT Hyderabad.</p><div class="profile-links">'+link('https://saswataiith.github.io/','Homepage')+link('https://www.iith.ac.in/msme/saswata/','Institute profile')+'</div></div></article></section>'
people+='<section class="tinted"><span class="eyebrow">ACADEMIC LINEAGE</span><h2>Academic advisers</h2><p>Prof. Saswata Bhattacharyya acknowledges the teachers who shaped his academic life on his personal website.</p><div class="profile-links"><a href="https://saswataiith.github.io/cv/#advisers">Read about his academic advisers →</a></div></section>'
