...
people+='<section class="pi"><h2>Group lead</h2><h3>Prof. Saswata Bhattacharya</h3><p>Professor, Materials Science and Metallurgical Engineering, IIT Hyderabad.</p><div class="profile-links">'+link('https://saswataiith.github.io/','Homepage')+link('https://www.iith.ac.in/msme/saswata/','Institute profile')+'</div></section>'
...
page('collaborators.html','Collaborators',heading('WORKING TOGETHER','Our <em>collaborators.</em>','Complementary expertise in experiments, theory and computation.')+'<section><div class="people collaborators">'+''.join(person_card(p,True) for p in data['sections'][2]['people'])+'</div></section><section class="tinted"><h2>Experiments and inverse modeling</h2><p>In our diffusion collaboration, Prof. Aloke Paul’s group at IISc leads the experimental diffusion studies and measurements. Our group at IIT Hyderabad develops the PINN and numerical inverse-modeling methods that connect those measurements with transport equations.</p></section>')
